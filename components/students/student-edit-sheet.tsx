  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const yearHint = academicYearId ? str(academicYearId) : "";
        const preferredYearId =
          (yearHint &&
          yr.academicYears.some((y) => str(y.id) === yearHint)
            ? yearHint
            : "") ||
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="flex w-full flex-col gap-0 overflow-y-auto sm:max-w-lg">
        <SheetHeader>
          ...
          <SheetDescription>
            Update profile details and class enrollment. Leave password blank to
        ...
        <div className="flex-1 px-4 pb-4">
          ...
          {loading ? (
            ...
            <form id="student-edit-sheet-form" className="grid gap-3" onSubmit={onSave}>
